...
* 4. The script labels the data set with names:
all feature names (attributes) and activity names are converted to lower case,
underscores and brackets () are removed.

* 5. The script merges the 10299x66 data frame containing features with
...
* 6. Finally, the script creates a 2nd, independent tidy data set with the average
